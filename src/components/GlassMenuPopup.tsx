...
export const GlassMenuPopup: React.FC<GlassMenuPopupProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 animate-in fade-in duration-200">
      ...
      <div
        onClick={onClose}
        className="absolute inset-0 bg-slate-900/30 dark:bg-black/65 backdrop-blur-md transition-opacity"
      />
      ...
      <div
        ...
        className="relative z-10 w-full max-w-2xl rounded-3xl border overflow-hidden p-4 sm:p-6 max-h-[90vh] flex flex-col no-scrollbar shadow-2xl text-slate-900 dark:text-white"
      >
