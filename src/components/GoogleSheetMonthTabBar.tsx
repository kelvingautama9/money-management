    ...
    <>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 animate-in fade-in duration-200">
          ...
          <div
            style={{
              background: isLight ? 'rgba(255, 255, 255, 0.96)' : 'rgba(11, 15, 29, 0.94)',
            ...
            className={`relative z-10 w-full max-w-md rounded-3xl border p-5 sm:p-6 shadow-2xl space-y-4 max-h-[85vh] flex flex-col ${
